...
export const AutoMapApiProperty = (
  metadata?: ApiPropertyOptions,
  exposeOptions?: ExposeOptions,
  ...
  AutoMap(typeFn as any)(target, propertyKey);
  // AutoMap(typeFn as any, exposeOptions, typeOptions)(target, propertyKey);
  // AutoMap(typeFn as any, exposeOptions, typeOptions)(target, propertyKey);
  ApiProperty(metadata)(target, propertyKey);
};
...
export const AutoMapApiPropertyOptional = (
  metadata?: ApiPropertyOptions,
  exposeOptions?: ExposeOptions,
  typeOptions?: TypeOptions
) => (target: any, propertyKey: string) => {
