...
export class ChatPanelComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  private _seekPerfectScrollbarDirectives: QueryList<
    SeekPerfectScrollbarDirective
  >;

  // Private
  private _chatViewScrollbar: SeekPerfectScrollbarDirective;
  ...
  ngAfterViewInit(): void {
    this._chatViewScrollbar = this._seekPerfectScrollbarDirectives.find(
      (directive) => {
  ...
  foldSidebarTemporarily(): void {
    this._seekSidebarService.getSidebar('chatPanel').foldTemporarily();
  }
  ...
  unfoldSidebarTemporarily(): void {
    this._seekSidebarService.getSidebar('chatPanel').unfoldTemporarily();
  }
  ...
  toggleSidebarOpen(): void {
    this._seekSidebarService.getSidebar('chatPanel').toggleOpen();
  }
