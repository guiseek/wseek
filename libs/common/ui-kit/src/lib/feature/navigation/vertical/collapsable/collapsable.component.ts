...
@Component({
  selector: 'seek-nav-vertical-collapsable',
  templateUrl: './collapsable.component.html',
  styleUrls: ['./collapsable.component.scss'],
  animations: seekAnimations,
})
export class SeekNavVerticalCollapsableComponent implements OnInit, OnDestroy {
  @Input()
  ...
  ngOnInit(): void {
    ...
    this._seekNavigationService.onItemCollapsed
  ...
  toggleOpen(ev): void {
    ...
    this._seekNavigationService.onItemCollapsed.next(this.item);
    this._seekNavigationService.onItemCollapseToggled.next();
  }
