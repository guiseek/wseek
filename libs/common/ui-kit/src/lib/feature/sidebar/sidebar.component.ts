...
@Component({
  selector: 'seek-sidebar',
  template: '<ng-content></ng-content>',
  styleUrls: ['./sidebar.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class SeekSidebarComponent implements OnInit, OnDestroy {
  // Name
  @Input()
  name: string;
  ...
  ngOnInit(): void {
    ...
    this._seekConfigService.config
      ...
      .subscribe((config) => {
        this._seekConfig = config;
      });

    // Register the sidebar
    this._seekSidebarService.register(this.name, this);
  ...
  ngOnDestroy(): void {
    ...
    this._seekSidebarService.unregister(this.name);
  ...
  private _showBackdrop(): void {
    ...
    this._backdrop.classList.add('seek-sidebar-overlay');

    // Add a class depending on the invisibleOverlay option
    if (this.invisibleOverlay) {
      this._backdrop.classList.add('seek-sidebar-overlay-invisible');
    }
