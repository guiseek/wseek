...
export class SeekInnerScrollDirective implements OnInit, OnDestroy {
  // Private
  private _parent: any;
   ...
   * @param {SeekMatchMediaService} _seekMediaMatchService
   * @param {Renderer2} _renderer
   */
  constructor(
    private _elementRef: ElementRef,
    private _seekMediaMatchService: SeekMatchMediaService,
  ...
  ngOnInit(): void {
    ...
    this._seekMediaMatchService.onMediaChange
